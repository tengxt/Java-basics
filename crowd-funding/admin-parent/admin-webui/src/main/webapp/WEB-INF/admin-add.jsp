            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="admin/page/doSave.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword2">用户密码</label>
                            <input type="password" name="userPswd" class="form-control" id="exampleInputPassword2" placeholder="请输入用户密码">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword3">用户昵称</label>
                            <input type="text" name="userName" class="form-control" id="exampleInputPassword3" placeholder="请输入用户昵称">
                        </div>
