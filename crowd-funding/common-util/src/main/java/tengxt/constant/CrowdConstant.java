...
public class CrowdConstant {
    ...
    public static final String MESSAGE_STRING_INVALIDATE = "字符串为空或长度为0";
    public static final String MESSAGE_SYSTEM_ERROR_LOGIN_NOT_UNIQUE = "错误！数据库中存在重复数据！";


    public static final String MESSAGE_ERROR_NOT_UNIQUE = "系统错误：登录账号不唯一！";
